...
public class SpawnManager : MonoBehaviour
{
    [Header("UI")]
    [Tooltip("생성 트리거용 버튼")]
    public Button player_SpawnButton;
    public Button enemy_SpawnButton;
    ...
    private void PlayerRandomSpawn()
    {
        ...
        // 2) 풀에서 꺼내기
        GameObject player_Pool = Shared.PoolManager.Spawn(player_Def.prefab, playerPoint.position);
    ...
    private void EnemyRandomSpawn()
    {
        ...
        // 2) 풀에서 꺼내기
        GameObject enemy_Pool = Shared.PoolManager.Spawn(enemy_Def.prefab, enemyPoint.position);
